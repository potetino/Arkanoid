...
TITUL()
{
  GCLRR (IDENT);
  GROP (IDENT, 0);
  MESSAGE    ("    Версия 1.01   сборка 26.09.25 ");
  STRA[0] = 07;
	STRA[1] = 0360;
...
srtBall()
{
	...
	int SUMMR = 0;
	int SUMMY = 0;
    short BGX1,BGX2,BGY1,BGY2;
    short BRX1,BRX2,BRY1,BRY2;
    short BYX1,BYX2,BYY1,BYY2;
  BGX1 = XC;
  BGY1 = YC + 30;
  BGX2 = XC + 12;
  BGY2 = YC + 41;
...
{
  short j,k,l,p;
  short RRX1,RRX2,RRY1,RRY2;
  short RBX1,RBX2,RBY1,RBY2;
  short RWX1,RWX2,RWY1,RWY2;
  short RGX1,RGX2,RGY1,RGY2;
	short SUMMRD = 0;
	short SUMMBL = 0;
	short SUMMWN = 0;
	short SUMMGR = 0;
...
bl = ball;
    /* Кэшируем вычисления */
    cos_alfa = cos(ball.alfa);
    sin_alfa = sin(ball.alfa);
    
moveBall((int)floor(ball.xb + cos_alfa * ball.speed), 
(int)floor(ball.yb + sin_alfa * ball.speed));
...
for(i=0; i < N; ++i)
	{
		...
		block[i].blwidth = 21;
		block[i].blheight = 5;
        block[i].active = 1; /* все блоки активны */
	}
}
...
OnePBlock1to4(lvl)
{
    switch(lvl) {
        ...
        case 4:
            ...
            default: /* Обработка остальных случаев не требуется */
            break;
    }
}
    ...
    switch(lvl) {
        case 5:
            for(i = 12; i < N; ++i) {
                ...
                else if((i >= 52 && i <= 56) || (i >= 64 && i <= 68) || 
                        i == 75 || i == 76 || i == 78 || i == 80 || i == 81 || 
                        i == 87 || i == 88 || i == 90 || i == 92 || i == 93 || 
                        i == 98 || (i >= 99 && i <= 106) || (i >= 110 && i <= 118) || 
                        i == 122 || (i >= 124 && i <= 126)) 
                {
                    GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
                }
                else if(i == 127 || i == 128 || i == 130 || i == 134 || i == 136 || 
                        i == 140 || i == 142 || i == 146 || i == 148 || i == 152 || 
                        i == 154 || i == 161 || i == 163 || i == 173 || i == 175) 
                {
                    GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
                }
    ...
    switch(lvl) {
        case 8:
            for(i = 12; i < 139; ++i) {
                ...
                else if(i == 20 || i == 21 || i == 31 || i == 34 || 
                       i == 42 || i == 47 || i == 59 || i == 71 || 
                       i == 83 || i == 94 || i == 105 || i == 116 || 
                       i == 127 || i == 138) 
                {
                    GRVR(IDENT, block[i].xo, block[i].yo, &ADGREY);
                }
        ...
        case 9:
            for(i = 21; i < 182; ++i) {
                ...
                if(i == 21 || i == 22 || i == 34 || 
                  ...
                  i == 86 || (i >= 88 && i <= 90) || 
                  i == 92 || i == 94 || i == 96 || i == 98 || 
                  i == 100 || i == 102 || i == 104 || i == 106 || 
                  i == 108 || i == 110 || i == 112 || i == 114 || 
                  i == 116 || i == 118 || i == 120 || i == 122 || 
                  (i >= 124 && i <= 126) || i == 128 || i == 130 || 
                  i == 132 || i == 134 || i == 140 || i == 142 || 
                  i == 144 || i == 146 || i == 152 || i == 154 || 
                  i == 156 || (i >= 158 && i <= 164) || 
                  i == 166 || i == 168 || i == 178 || i == 180 || i == 181) 
                {
                    GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
                }
            }
        ...
        case 10:
            ...
            for(i = 76; i < 164; ++i) {
                if (!block[i].active) continue;
                if((i >= 76 && i <= 79) || i == 87 || i == 92 || 
                   i == 98 || (i >= 100 && i <= 103) || i == 105 || 
                   i == 109 || i == 111 || i == 113 || i == 114 || 
                   i == 116 || i == 118 || i == 121 || i == 123 || 
                   i == 125 || i == 126 || i == 128 || i == 130 || 
                   i == 134 || (i >= 136 && i <= 139) || i == 141 || 
                   i == 147 || i == 152 || (i >= 160 && i <= 163)) 
                {
                    GRVR(IDENT, block[i].xo, block[i].yo, &ADBLU);
                }
            }
...
/* Вспомогательные функции для каждого уровня */
...
round5() {
    ...
    for(i = 15; i < 176; ++i) {
        if(i == 16 || i == 20 || i == 29 || i == 31 || i == 41 || i == 43 || 
           (i >= 52 && i <= 56) || (i >= 64 && i <= 68) || (i >= 75 && i <= 81) || 
           (i >= 87 && i <= 93) || (i >= 98 && i <= 106) || i == 110 || i == 111) {
            if (!block[i].active) continue;
            if (ball.x <= block[i].xo + block[i].blwidth && block[i].xo <= ball.x + ball.width && 
                ball.y <= block[i].yo + block[i].blheight && block[i].yo <= ball.y + ball.height)
                return TRUE;
        }
        else if((i >= 112 && i <= 118) || i == 122 || (i >= 124 && i <= 128) || i == 130 || 
                i == 134 || i == 136 || i == 140 || i == 142 || i == 146 || i == 148 || 
                i == 152 || i == 154 || i == 161 || i == 163 || i == 173 || i == 175) {
            if (!block[i].active) continue;
            if (ball.x <= block[i].xo + block[i].blwidth && block[i].xo <= ball.x + ball.width && 
                ball.y <= block[i].yo + block[i].blheight && block[i].yo <= ball.y + ball.height)
                return TRUE;
...
round7()
{
    int g, start, end, desiredParity, i0;
    struct blockdef *b;
    int bx1, bx2, by1, by2;

    /* Предвычисляем границы мяча */
    bx1 = ball.x;
    bx2 = ball.x + ball.width;
    by1 = ball.y;
    by2 = ball.y + ball.height;

    /* 8 групп по 12 блоков каждая: [12..23], [24..35], ... [96..107] */
    for (g = 0; g < 8; ++g) {
        start = 12 + g * 12;
        end   = start + 12;
        /* в оригинале: для групп 0,2,4,6 - чётные индексы; для 1,3,5,7 - нечётные */
        desiredParity = (g % 2 == 0) ? 0 : 1;

        /* найти первый индекс в диапазоне с нужной чётностью */
        if ((start % 2) != desiredParity)
            i0 = start + 1;
        else
            i0 = start;

        /* итерируемся с шагом 2 - проверяем только нужную чётность */
        for (i = i0; i < end; i += 2) {
            if (!block[i].active)
                continue;
            b = &block[i];
            if (bx1 <= b->xo + b->blwidth && b->xo <= bx2 &&
                by1 <= b->yo + b->blheight && b->yo <= by2)
                return TRUE;
        }
    }
    return FALSE;
...
round8() { 
    ...
    for(i = 12; i < 139; ++i) {
        if(i == 20 || i == 21 || i == 31 || i == 34 || i == 42 || i == 47 || i == 59 || i == 71 || 
           i == 83 || i == 94 || i == 105 || i == 116 || i == 127 || i == 138 || i == 14 || i == 15 || 
           i == 25 || i == 26 || i == 27 || i == 28 || (i >= 36 && i <= 41) || (i >= 48 && i <= 53) || 
           (i >= 60 && i <= 65) || (i >= 72 && i <= 77) || (i >= 85 && i <= 89) || 
           (i >= 98 && i <= 101) || i == 111 || i == 112 || i == 113 || i == 124 || i == 125 || i == 137) {
            if (!block[i].active) continue;
            if (ball.x <= block[i].xo + block[i].blwidth && block[i].xo <= ball.x + ball.width && 
                ball.y <= block[i].yo + block[i].blheight && block[i].yo <= ball.y + ball.height)
                return TRUE;
...
round9() {
    ...
    for(i = 21; i < 182; ++i) {
        if(i == 21 || i == 22 || i == 34 || (i >= 36 && i <= 44) || i == 46 || i == 48 || i == 56 || 
           i == 58 || i == 60 || (i >= 62 && i <= 66) || i == 68 || i == 70 || i == 72 || i == 74 || 
           i == 78 || i == 80 || i == 82 || i == 84 || i == 86 || (i >= 88 && i <= 90) || i == 92 || 
           i == 94 || i == 96 || i == 98 || i == 100 || i == 102 || i == 104 || i == 106 || i == 108 || 
           i == 110 || i == 112 || i == 114 || i == 116 || i == 118 || i == 120 || i == 122 || 
           (i >= 124 && i <= 126) || i == 128 || i == 130 || i == 132 || i == 134 || i == 140 || 
           i == 142 || i == 144 || i == 146 || i == 152 || i == 154 || i == 156 || 
...
roundN() {
    ...
    for(i = 76; i < 164; ++i) {
        if((i >= 76 && i <= 79) || i == 87 || i == 92 || i == 98 || (i >= 100 && i <= 103) || 
           i == 105 || i == 109 || i == 111 || i == 113 || i == 114 || i == 116 || i == 118 || 
           i == 121 || i == 123 || i == 125 || i == 126 || i == 128 || i == 130 || i == 134 || 
           (i >= 136 && i <= 139) || i == 141 || i == 147 || i == 152 || (i >= 160 && i <= 163)) {
            if (!block[i].active) continue;
            if (ball.x <= block[i].xo + block[i].blwidth && block[i].xo <= ball.x + ball.width && 
                ball.y <= block[i].yo + block[i].blheight && block[i].yo <= ball.y + ball.height)
                return TRUE;
...
Level4() {
    block[i].active = 0; 
    if(i >= 12 && i < 72) {
        if(i == 12 || i == 14 || i == 15 || i == 16 || i == 18 || i == 19 || 
           i == 20 || i == 22 || i == 24 || i == 26 || i == 28 || i == 30 || 
           i == 34 || i == 36 || i == 38 || i == 39 || i == 40 || i == 42 || 
           i == 43 || i == 44 || i == 46 || i == 48 || i == 52 || i == 54 || 
           i == 56 || i == 58 || i == 60 || i == 62 || i == 63 || i == 64 || 
           i == 66 || i == 67 || i == 68 || i == 70) {
            GRVR(IDENT, block[i].xo, block[i].yo, &ADGREY);
        }
        else {
...
Level5() {
    ...
    else if(i == 52 || i == 53 || i == 54 || i == 55 || i == 56 || 
            i == 64 || i == 65 || i == 66 || i == 67 || i == 68 ||
            i == 75 || i == 76 || i == 78 || i == 80 || i == 81 || 
            i == 87 || i == 88 || i == 90 || i == 92 || i == 93 || i == 98) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
    }
    else if(i == 99 || i == 100 || i == 101 || i == 102 || i == 103 || 
            i == 104 || i == 105 || i == 106 || i == 110 || i == 111 ||
            i == 112 || i == 113 || i == 114 || i == 115 || i == 116 || 
            i == 117 || i == 118 || i == 122 || i == 124 || i == 125 || i == 126) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
    }
    else if(i == 127 || i == 128 || i == 130 || i == 134 || i == 136 || 
            i == 140 || i == 142 || i == 146 || i == 148 || i == 152 || 
...
Level7() {
    ...
    else if(i >= 24 && i < 36 && i % 2 != 0) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADGREY);
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
    }
    else if(i >= 36 && i < 48 && i % 2 == 0) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
    }
    else if(i >= 48 && i < 60 && i % 2 != 0) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
    }
    else if(i >= 60 && i < 72 && i % 2 == 0) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADGREY);
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
    }
    else if(i >= 72 && i < 84 && i % 2 != 0) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADGREY);
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
    }
    else if(i >= 84 && i < 96 && i % 2 == 0) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
    }
    else if(i >= 96 && i < 108 && i % 2 != 0) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
    }
    block[i].xo = 0; block[i].yo = 0;
    printScore();
...
Level8() {
    block[i].active = 0; 
    if(i == 14 || i == 15 || i == 25 || i == 26 || i == 27 || i == 28 || 
       i == 36 || i == 37 || i == 38 || i == 39 || i == 40 || i == 41 || 
       i == 48 || i == 49 || i == 50 || i == 51 || i == 52 || i == 53 || 
       i == 60 || i == 61 || i == 62 || i == 63 || i == 64 || i == 65 || 
       i == 72 || i == 73 || i == 74 || i == 75 || i == 76 || i == 77 || 
       i == 85 || i == 86 || i == 87 || i == 88 || i == 89 || 
       i == 98 || i == 99 || i == 100 || i == 101 || 
       i == 111 || i == 112 || i == 113 || i == 124 || i == 125 || i == 137) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADRED);
        printScore();
    }
    else if(i == 20 || i == 21 || i == 31 || i == 34 || i == 42 || i == 47 || 
            i == 59 || i == 71 || i == 83 || i == 94 || i == 105 || i == 116 || 
            i == 127 || i == 138) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADRED);
    }
    block[i].xo = 0; block[i].yo = 0;
...
Level9() {
    block[i].active = 0; 
    if(i == 21 || i == 22 || i == 34 || (i >= 36 && i <= 44) || i == 46 || 
       i == 48 || i == 56 || i == 58 || i == 60 || (i >= 62 && i <= 66) || 
       i == 68 || i == 70 || i == 72 || i == 74 || i == 78 || i == 80 || 
       i == 82 || i == 84 || i == 86 || (i >= 88 && i <= 90) || i == 92 || 
       i == 94 || i == 96 || i == 98 || i == 100 || i == 102 || i == 104 || 
       i == 106 || i == 108 || i == 110 || i == 112 || i == 114 || i == 116 || 
       i == 118 || i == 120 || i == 122 || (i >= 124 && i <= 126) || i == 128 || 
       i == 130 || i == 132 || i == 134 || i == 140 || i == 142 || i == 144 || 
       i == 146 || i == 152 || i == 154 || i == 156 || (i >= 158 && i <= 164) || 
       i == 166 || i == 168 || i == 178 || i == 180 || i == 181) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADYEL);
        block[i].xo = 0; block[i].yo = 0;
        printScore();
...
LevelNEXT() {
    block[i].active = 0; 
    if((i >= 76 && i <= 79) || i == 87 || i == 92 || i == 98 || 
       (i >= 100 && i <= 103) || i == 105 || i == 109 || i == 111 || 
       i == 113 || i == 114 || i == 116 || i == 118 || i == 121 || 
       i == 123 || i == 125 || i == 126 || i == 128 || i == 130 || 
       i == 134 || (i >= 136 && i <= 139) || i == 141 || i == 147 || 
       i == 152 || (i >= 160 && i <= 163)) {
        GRVR(IDENT, block[i].xo, block[i].yo, &ADBLU);
        block[i].xo = 0; block[i].yo = 0;
        printScore();
...
blockCollision()
{
    if(CollisionWall() == TRUE && block[i].xo != 0 && block[i].yo != 0) {
        switch(lvl) {
            case 1: Level1(); break;
            case 2: Level2(); break;
            case 3: Level3(); break;
...
ARKANOID()
{
	static int lvl_threshold[] = {0, 60, 96, 72, 60, 67, 96, 48, 45, 76, 36}; /* жизни в уровнях */
	GCLRR(IDENT);
	PAL.PMODPAL=MODP;
	PLSAV (&PAL);
	tmp=PAL.PAL[15];
	...
	GFILL(IDENT1,0,120);
	  ...
	  WPRINT (ANUM1, 136, MAXY1-30, SSCO);
		...
		while (TRUE) {
			   ...
			   if (lvl >= 1 && lvl <= 10 && score >= lvl_threshold[lvl]) {
   					 if (lvl == 10) {
        				lvl = 11;
        				break;
   						 } 
